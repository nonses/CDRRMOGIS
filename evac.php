     ...
     <div class="container"> <!--Content starts here-->
        ...
        <div style="margin: auto; text-align: center;" class="pull-right">
            <div class="btn-group" role="group" aria-label="...">
                ...
                <a href="evac.php" class="btn btn-secondary active">Evacuation Centers</a>   
...
<script>
 ...
 var littleton = L.marker([10.69384, 482.57165]).bindPopup('Ortiz Gymn.'),
    denver    = L.marker([10.69882, 482.55663]).bindPopup('Example.'),
    aurora    = L.marker([10.70725, 482.55702]).bindPopup('Example'),
    golden    = L.marker([10.71033, 482.58478]).bindPopup('Example');
